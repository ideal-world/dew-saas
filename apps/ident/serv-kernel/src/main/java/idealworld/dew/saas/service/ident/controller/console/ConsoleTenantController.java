 ...
 */
@RestController
@Tag(name = "console tenant", description = "租户控制台租户管理操作")
...
public class ConsoleTenantController extends BasicController {
     ...
     */
    @DeleteMapping(value = "")
    @Operation(summary = "注销当前的租户，必须先删除关联的应用，此操作会同时与此租户相关的所有数据")
