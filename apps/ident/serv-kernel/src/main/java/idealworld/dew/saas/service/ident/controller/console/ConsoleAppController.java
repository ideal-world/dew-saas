 ...
 */
@RestController
@Tag(name = "console app", description = "租户控制台应用管理操作")
...
public class ConsoleAppController extends BasicController {
    ...
    @Operation(summary = "删除当前租户的某个应用、应用认证、机构、职位、岗位、账号岗位、权限")
    ...
    @Operation(summary = "添加当前租户某个应用的认证")
    ...
    @Operation(summary = "获取当前租户某个应用的认证列表信息")
    ...
    @Operation(summary = "修改当前租户某个应用的某个认证")
    ...
    @Operation(summary = "删除当前租户某个应用的某个认证")
    ...
    @Operation(summary = "删除当前租户某个应用的所有认证")
