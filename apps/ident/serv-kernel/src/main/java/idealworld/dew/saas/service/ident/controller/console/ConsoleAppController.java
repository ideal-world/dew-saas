...
public class ConsoleAppController extends BasicController {
    ...
    @ApiOperation(value = "删除当前租户的某个应用", notes = "删除应用、应用认证、机构、职位、岗位、账号岗位、权限")
    ...
    @ApiOperation(value = "添加当前租户某个应用的认证")
    ...
    @ApiOperation(value = "获取当前租户某个应用的认证列表信息")
    ...
    @ApiOperation(value = "修改当前租户某个应用的某个认证")
    ...
    @ApiOperation(value = "删除当前租户某个应用的某个认证")
    ...
    @ApiOperation(value = "删除当前租户某个应用的所有认证")
