 ...
 */
@RestController
@Tag(name = "app organization", description = "应用控制台机构管理操作")
...
public class AppOrganizationController extends BasicController {
     ...
     */
    @GetMapping(value = "")
    @Operation(summary = "获取当前应用的机构列表信息")
    ...
    @Operation(summary = "删除当前应用的某个机构、关联的岗位、账号岗位、权限")
